...
(function() {
                            ...
                            if (e !== " ") {
                                ...
                                if (m) {
                                    for (var p = e.replace(/([^\^])-/g, "$1- ").split(" "), o = g.length > 1 || f || p.length > 1 && k.whiteSpace !== "nowrap", v, G, r, s = [], q = N(l), u = 1, x = a.rotation, w = e, A = w.length;
                                        (o || y) && (p.length ||
                                            s.length);) a.rotation = 0, v = a.getBBox(!0), r = v.width, !da && c.forExport && (r = c.measureSpanWidth(l.firstChild.data, a.styles)), v = r > m, G === void 0 && (G = v), y && G ? (A /= 2, w === "" || !v && A < 0.5 ? p = [] : (v && (G = !0), w = e.substring(0, w.length + (v ? -1 : 1) * ta(A)), p = [w + (m > 3 ? "â€¦" : "")], l.removeChild(l.firstChild))) : !v || p.length === 1 ? (p = s, s = [], p.length && (u++, l = B.createElementNS(Aa, "tspan"), J(l, {
                                        dy: q,
                                        x: j
    ...
    C.geojson = function(a, b, c) {
        ...
        if (c && a.copyrightShort) c.chart.mapCredits = '<a href="http://www.highcharts.com">Highcharts</a> Â© <a href="' + a.copyrightUrl + '">' + a.copyrightShort + "</a>", c.chart.mapCreditsFull = a.copyright;
        return d
    };
